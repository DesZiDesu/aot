"""Shared utilities — i18n, data helpers, constants."""
...
# AoT-themed dark green embed color
...
DEFAULT_CONFIG = {
    ...
    "special_access": {},
    "shifter_access": [],
    # per-bloodline eligibility: True = can become mindless/shifter, False = cannot
    "bloodline_mindless_eligible": {},   # e.g. {"Ackerman": False}
    "bloodline_shifter_eligible": {},    # e.g. {"Ackerman": True}
    ...
    "mindless_fluid_item": "",
    "xp_enabled": True,
    # role required to create a character (None = anyone)
    "character_creation_role": None,
}
...
LANG = {
    "th": {
        ...
        "image_field": "รูปโปรไฟล์ (URL ไม่บังคับ)",
        "name_label": "ชื่อ",
        "age_label": "อายุ",
        "gender_label": "เพศ",
        ...
        "no_ann_channels": "❌ ยังไม่ได้ตั้งค่าช่องทางประกาศ ใช้ /config เพื่อตั้งค่า",
        ...
        # Economy extras
        "transfer_btn": "💸 โอนเงิน",
        "transfer_amount_field": "จำนวนเงิน",
        "transfer_success": "✅ โอน **{amount}** {currency} ให้ **{target}** แล้ว",
        "transfer_received": "💸 **{sender}** โอน **{amount}** {currency} ให้คุณ!",
        "transfer_insufficient": "❌ เงินไม่เพียงพอ",
        "admin_grant_btn": "➕ เพิ่มเงิน (แอดมิน)",
        "admin_remove_btn": "➖ ลดเงิน (แอดมิน)",
        "admin_grant_amount_field": "จำนวนเงิน",
        "admin_grant_success": "✅ เพิ่ม **{amount}** {currency} ให้ **{target}** แล้ว",
        "admin_remove_success": "✅ ลด **{amount}** {currency} จาก **{target}** แล้ว",
        # Profile admin extras
        "admin_view_profile_btn": "👁️ ดูโปรไฟล์ผู้เล่น",
        "admin_flag_death_btn": "☠️ ตั้งสถานะเสียชีวิต",
        "player_death_confirm": "คุณแน่ใจหรือไม่ว่าต้องการลบตัวละครของ **{name}**? ไม่สามารถย้อนกลับได้",
        "player_deleted_msg": "✅ ลบตัวละครของ **{name}** แล้ว พวกเขาจะต้องสร้างตัวละครใหม่",
        "player_death_dm": "☠️ ตัวละครของคุณถูกทำเครื่องหมายว่าเสียชีวิตและถูกลบโดยแอดมิน ใช้ `/profile` เพื่อสร้างตัวละครใหม่",
        # Character creation role gate
        "no_creation_role": "❌ คุณต้องมีบทบาท **{role}** ก่อนจึงจะสร้างตัวละครได้",
        "set_creation_role_btn": "🔑 ตั้งบทบาทสร้างตัวละคร",
        # Mindless extras
        "mindless_revert_btn": "🔄 คืนสภาพมนุษย์ (แอดมิน)",
        "mindless_reverted_msg": "✅ **{name}** ถูกคืนสภาพเป็นมนุษย์แล้ว",
        "mindless_reverted_dm": "🔄 คุณถูกคืนสภาพเป็นมนุษย์โดยแอดมิน",
        "mindless_cannot_inject_shifter": "❌ ผู้แปลงร่างไม่สามารถกลายเป็นไทแทนไร้สติได้",
        "mindless_cannot_inject_bloodline": "❌ สายเลือด **{bloodline}** ไม่สามารถกลายเป็นไทแทนไร้สติได้",
        "mindless_injected_notify": "💉 คุณถูกฉีดยาจาก **{injector}** และกลายเป็นไทแทนที่ไร้สติ!\n\nใช้ `/mindless` เพื่อควบคุมตัวเอง",
        "select_multiple_targets": "เลือกเป้าหมาย (หลายคน)",
        "mindless_inject_select_btn": "💉 เลือกเป้าหมาย",
    },
    "en": {
        ...
        "image_field": "Profile Image (URL, optional)",
        "name_label": "Name",
        "age_label": "Age",
        "gender_label": "Gender",
        ...
        "no_ann_channels": "❌ No announcement channels configured. Use /config to set them.",
        ...
        # Economy extras
        "transfer_btn": "💸 Transfer Money",
        "transfer_amount_field": "Amount",
        "transfer_success": "✅ Transferred **{amount}** {currency} to **{target}**.",
        "transfer_received": "💸 **{sender}** sent you **{amount}** {currency}!",
        "transfer_insufficient": "❌ Insufficient funds.",
        "admin_grant_btn": "➕ Grant Money (Admin)",
        "admin_remove_btn": "➖ Remove Money (Admin)",
        "admin_grant_amount_field": "Amount",
        "admin_grant_success": "✅ Granted **{amount}** {currency} to **{target}**.",
        "admin_remove_success": "✅ Removed **{amount}** {currency} from **{target}**.",
        # Profile admin extras
        "admin_view_profile_btn": "👁️ View Player Profile",
        "admin_flag_death_btn": "☠️ Flag as Deceased",
        "player_death_confirm": "Are you sure you want to delete **{name}**'s character? This cannot be undone.",
        "player_deleted_msg": "✅ **{name}**'s character has been deleted. They must create a new one.",
        "player_death_dm": "☠️ Your character has been marked as deceased and deleted by an admin. Use `/profile` to create a new character.",
        # Character creation role gate
        "no_creation_role": "❌ You need the **{role}** role before you can create a character.",
        "set_creation_role_btn": "🔑 Set Character Creation Role",
        # Mindless extras
        "mindless_revert_btn": "🔄 Revert to Human (Admin)",
        "mindless_reverted_msg": "✅ **{name}** has been reverted to human.",
        "mindless_reverted_dm": "🔄 You have been reverted to human form by an admin.",
        "mindless_cannot_inject_shifter": "❌ Shifters cannot become Mindless Titans.",
        "mindless_cannot_inject_bloodline": "❌ The **{bloodline}** bloodline cannot become Mindless Titans.",
        "mindless_injected_notify": "💉 You were injected by **{injector}** and have become a Mindless Titan!\n\nUse `/mindless` to control yourself.",
        "select_multiple_targets": "Select targets (multi)",
        "mindless_inject_select_btn": "💉 Select Targets",
    },
}
...
async def send_dm(user, content: str = None, embed=None) -> bool:
    """Send a DM embed/content. Returns True on success."""
    import discord
    try:
    ...
    for g in bot_instance.guilds:
        if g.id == guild_id:
            ...
            if ch:
                try:
                    embed = _d.Embed(
                        description=f"[{category.upper()}] {text}",
                        color=EMBED_COLOR,
                    )
...
def can_become_mindless(guild_id: int, player: dict) -> tuple:
    ...
    eligibility = cfg.get("bloodline_mindless_eligible", {})
    if bl in eligibility and not eligibility[bl]:
        return False, "mindless_cannot_inject_bloodline"
    # Default: Ackerman cannot become mindless
    if bl == "Ackerman" and bl not in eligibility:
        return False, "mindless_cannot_inject_bloodline"
    return True, ""


def can_become_shifter(guild_id: int, player: dict) -> bool:
    cfg = load_config(guild_id)
    bl = player.get("bloodline", "")
    eligibility = cfg.get("bloodline_shifter_eligible", {})
    if bl in eligibility:
        return eligibility[bl]
    return True
